...
public abstract class SimplePagerAdapter<E> extends PagerAdapter {
    ...
    public void setPageNow(ViewPager pv){
        pv.setCurrentItem(mEntities.size()*10000/2);
    }
    @Override
    public int getCount() {
        return mEntities.size()*10000;
    }
    
    public  abstract int setLayouResID();
    
    public abstract  void initView(View itemView,ViewGroup container, int position,E enity);
    @Override
